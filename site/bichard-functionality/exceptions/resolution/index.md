...
| HO100302 | PNC Query failed (e.g. communications failure, timeout) |
|----------|----------|
...
| HO100324 | Inconsistent result: Adjournment pre Judgement but PNC has an adjudication |
|----------|----------|
